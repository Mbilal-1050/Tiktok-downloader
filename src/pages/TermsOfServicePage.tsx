    ...
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mb-10 text-left border-b border-neutral-800 pb-8">
        ...
        <p className="text-sm sm:text-base text-neutral-400 leading-relaxed">
          {lang === 'ur'
            ? 'TikSave Pro استعمال کرنے سے پہلے برائے مہربانی ان شرائط و ضوابط کو بغور پڑھیں۔ ہماری ویب سائٹ استعمال کرنے کا مطلب ہے کہ آپ ان تمام شرائط سے متفق ہیں۔'
            : 'Please read these Terms of Service carefully before using TikSave Pro. By accessing or using our platform, you acknowledge and agree to be bound by these terms.'}
        </p>
      </div>
      ...
      <div className="space-y-8 text-sm text-neutral-300 leading-relaxed text-left">
        ...
        <section className="space-y-3">
          ...
          <p>
            By accessing or using the TikSave Pro website, services, and online tools (collectively, the "Service"), you agree to be bound by these Terms of Service. If you disagree with any part of the terms, you must discontinue the use of our services immediately.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            TikSave Pro is provided as a utility tool to assist users in saving, archiving, and previewing public video and audio media for strictly <strong>personal, educational, and non-commercial fair-use purposes</strong>.
          </p>
        ...
        <section className="space-y-3">
          ...
          <p>
            TikSave Pro does <strong>NOT claim any ownership or copyright</strong> over the media, sounds, images, or videos processed through our platform. All trademarks, copyrights, audio tracks, and visual assets belong to their respective creators, publishers, and platforms (including TikTok and ByteDance Ltd.).
          </p>
          <p>
        ...
        <section className="space-y-3">
          ...
          <div className="p-4 rounded-2xl bg-amber-950/20 border border-amber-800/40 text-amber-200/90 text-xs">
            ...
            TikSave Pro is provided on an "as-is" and "as-available" basis without warranties of any kind, whether express or implied. We do not guarantee that the service will be uninterrupted, error-free, or compatible with future modifications made to third-party social media platforms.
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            In no event shall TikSave Pro, its operators, affiliates, or contributors be held liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from the use of, or inability to use, our service.
          </p>
        </section>
        ...
        <section className="space-y-3 border-t border-neutral-800 pt-6">
          ...
          <div className="p-4 rounded-2xl bg-neutral-900 border border-neutral-800 flex items-center justify-between mt-3">
            <span className="font-mono text-xs sm:text-sm text-cyan-400">legal@tiksave.pro</span>
